package com.craftlink.backend.auth.adapter.in.web;
...
import com.craftlink.backend.auth.adapter.in.web.mapper.AuthWebMapper;
...
//  }
  ...
  public ResponseEntity<AuthResponseDto> refreshToken(
    ...
    var accessToken = refreshTokenUseCase.handle(new RefreshTokenCommand(token));
